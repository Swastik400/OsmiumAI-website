...
const faqs = [
  ...
  { q: "Who built Osmium?", a: "Osmium is built by Navchetna Technologies (NINELLMS SOLUTIONS LLP), a passionate team of student innovators dedicated to transforming education through AI." },
];
