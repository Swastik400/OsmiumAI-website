            ...
            <div className="relative isolate overflow-hidden rounded-3xl bg-warm-50">
              ...
              <article className="p-6 sm:p-10 md:p-14 space-y-10">
                ...
                <div>
                  ...
                  <p className="type-sm text-warm-600 mb-4">
                    You have full control over your personal data. As a user,
                    you can:
                  </p>
                  <ul className="space-y-3">
                    {[
                      "Access or update your personal information at any time",
                      "Request deletion of your account and associated data",
                      "Revoke camera and app permissions via your device settings",
                      "Contact us to exercise any data rights or raise concerns",
                    ].map((item) => (
                      <li key={item} className="flex gap-3">
                        <span className="mt-1.5 size-1.5 rounded-full bg-brand flex-none" />
                        <p className="type-sm text-warm-600">{item}</p>
                ...
                <div>
                  ...
                  <p className="type-sm text-warm-600">
                    We retain user data for as long as your account is active or
                    as needed to provide services. If you delete your account, we
                    remove all associated data unless retention is required for
                    legal or academic purposes.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="type-sm text-warm-600">
                    ...
                    be reflected with a new &ldquo;Last updated&rdquo; date.
                    Major changes will be notified via email or in-app alerts
                    where applicable.
                  </p>
                </div>
                ...
                <div className="text-center py-4">
                  ...
                  <p className="mt-6 type-2xs text-warm-300">
                    &copy; 2025 Osmium by Navchetna &middot;{" "}
                    <a
                      href="https://osmium.co.in"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:text-warm-500 transition-colors"
                    >
                      osmium.co.in
                    </a>
                  </p>
